<?php 
	...
	$limit = 2;
	$offset = ($hal - 1)*$limit;	
	$hasil = mysql_query("select * from content order by kode_content desc limit $offset,$limit;");
...
<div id="templatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div>
        	<?php if($hal > 1){ ?>
        	<a href="<?php echo $_SERVER['PHP_SELF']; ?>?page=home&hal=<?php echo ($hal-1); ?>" style="font-size:18px; text-decoration:none; float:left;">&lt;&lt;&nbsp;&nbsp;Prev</a>
           	<?php 
				}if($hal < $total_page){
			?>
            
            <a href="<?php echo $_SERVER['PHP_SELF']; ?>?page=home&hal=<?php echo ($hal+1); ?>" style="font-size:18px; text-decoration:none; float:right;">Next&nbsp;&nbsp;&gt;&gt;</a>
            <?php } ?>
        </div>
